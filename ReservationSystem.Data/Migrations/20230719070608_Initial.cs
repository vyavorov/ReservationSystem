    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipmentsReservations", x => new { x.EquipmentId, x.ReservationId });
                    table.ForeignKey(
                        name: "FK_EquipmentsReservations_Equipments_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EquipmentsReservations_Reservations_ReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EquipmentsReservations_ReservationId",
